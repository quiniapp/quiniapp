...
export function startSessionCleanupJob() {
    ...
    console.log(`[SessionCleanup] Inactivity timeout: ${SESSION_CONFIG.INACTIVITY_TIMEOUT / 1000 / 60 / 60} hours`);
    console.log(`[SessionCleanup] Absolute timeout: ${SESSION_CONFIG.ABSOLUTE_TIMEOUT / 1000 / 60 / 60 / 24} days\n`);
 ...
 * Get job status
 */
export function isCleanupJobRunning() {
