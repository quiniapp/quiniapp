...
export class LotteryController {
    constructor() {
        ...
        this.getAll = async (all, organization_id) => {
            try {
        ...
        this.getAllByDay = async (day, all, organization_id) => {
            try {
                // Get lottery IDs that are configured for this day
                const lotteryIds = await this.scheduleLotteryController.getLotteryIdsForDay(organization_id, day);
                // Get all lotteries
                ...
                const filteredLotteries = allLotteries.filter((lottery) => lotteryIds.includes(lottery.lottery_id));
