...
/**
 * NEW Session-based authentication middleware (Phase 2)
 * Validates JWT access token and session in database with sliding window
 *
 * This middleware will replace the old isAuthenticated in Phase 4
 * For now, it's available for testing new session system
 *
 * Features:
 ...
 */
export const isAuthenticatedWithSession = asyncHandler(
