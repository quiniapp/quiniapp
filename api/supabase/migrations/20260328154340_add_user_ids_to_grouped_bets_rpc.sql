-- ============================================================================
-- Migration: Add p_user_ids parameter to get_grouped_bets_for_parse RPCs
-- ============================================================================
-- When p_user_ids is provided, filter bets by user_id instead of organization_id.
-- When NULL, use existing behavior (filter by organization_id or return all).
-- ============================================================================

DROP FUNCTION IF EXISTS public.get_grouped_bets_for_parse(DATE, UUID, UUID, UUID, BOOLEAN, UUID);
DROP FUNCTION IF EXISTS public.get_grouped_bets_for_parse_archive(DATE, UUID, UUID, UUID, BOOLEAN, UUID);
