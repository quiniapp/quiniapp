-- ============================================================================
-- Migration: Create Archive RPCs for Bets
-- ============================================================================
-- This migration creates archive versions of bets-related RPCs
-- These functions query bets_archive table
-- for dates older than the last N active days
-- ============================================================================

-- ============================================================================
-- 1. get_grouped_bets_for_parse_archive
-- ============================================================================
-- Archive version of get_grouped_bets_for_parse
-- Queries bets_archive table
...
-- ============================================================================
-- 2. bets_total_amount_archive
-- ============================================================================
-- Archive version of bets_total_amount
-- Queries bets_archive table

CREATE OR REPLACE FUNCTION public.bets_total_amount_archive(
  p_date DATE,
  p_schedule_id UUID DEFAULT NULL,
  p_cashier_id UUID DEFAULT NULL,
  p_lottery_id UUID DEFAULT NULL,
...
-- ============================================================================
-- 3. bets_total_prize_archive
-- ============================================================================
-- Archive version of bets_total_prize
-- Queries bets_archive table

CREATE OR REPLACE FUNCTION public.bets_total_prize_archive(
  p_date DATE,
  p_schedule_id UUID DEFAULT NULL,
  p_cashier_id UUID DEFAULT NULL,
  p_lottery_id UUID DEFAULT NULL,
