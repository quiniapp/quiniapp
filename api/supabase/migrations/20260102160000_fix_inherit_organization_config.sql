-- Fix: Update inherit_organization_config to match actual table structures
-- The original function used incorrect column names
...
BEGIN
  ...
  -- schedules columns: schedule_id, name, time, is_active, organization_id, created_at, edited_at
  FOR v_schedule IN
