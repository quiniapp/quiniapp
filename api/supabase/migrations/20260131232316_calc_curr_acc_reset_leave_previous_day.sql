-- ============================================================================
-- Fix: Reset drag when previous day was liquidated with leave > 0
-- ============================================================================
-- El drag debe resetearse a 0 cuando el día ANTERIOR fue liquidado con leave > 0
-- No debe depender de p_calculate_leave del día actual
-- ============================================================================
...
BEGIN
  ...
  calculated_data AS (
    SELECT
      ...
      -- ✅ CORRECCIÓN: Resetear drag si el día ANTERIOR fue liquidado con leave > 0
      CASE
