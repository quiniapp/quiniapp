-- ============================================================================
-- Migration: Fix ticket_full_json_plpgsql to group by bet_order
-- ============================================================================
-- This migration updates ticket_full_json_plpgsql to group bets by bet_order
-- instead of by number/amount/place/with/position. This ensures that bets
-- with the same number but different amounts are returned as separate entries.
-- Also adds bet_order to the JSON output for use as a key in the frontend.
-- ============================================================================

DROP FUNCTION IF EXISTS public.ticket_full_json_plpgsql(UUID, UUID);
