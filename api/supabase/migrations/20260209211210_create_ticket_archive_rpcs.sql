-- ============================================================================
-- Migration: Create Archive RPCs for Tickets
-- ============================================================================
-- This migration creates archive versions of ticket-related RPCs
-- These functions query tickets_archive and bets_archive tables
-- for dates older than the last N active days
-- ============================================================================

-- ============================================================================
-- 1. ticket_full_json_plpgsql_archive
-- ============================================================================
-- Archive version of ticket_full_json_plpgsql
-- Queries tickets_archive and bets_archive tables
...
-- ============================================================================
-- 2. get_ticket_sums_archive
-- ============================================================================
-- Archive version of get_ticket_sums
-- Queries bets_archive table

CREATE OR REPLACE FUNCTION get_ticket_sums_archive(
  p_ticket TEXT,
