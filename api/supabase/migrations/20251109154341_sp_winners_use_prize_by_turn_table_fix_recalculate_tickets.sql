...
BEGIN
  ...
  /* 2) Winners ahora (solo tickets que ganaron en ESTE turno tras recalcular) */
  winners_now AS (
  ...
  /* 3) Candidates = winners_now ∪ los que ya tenían fila para este turno/fecha (ex-ganadores) */
  candidates AS (
  ...
  /* 5A) DELETE de filas que quedaron en 0 (limpia ex-ganadores de este turno) */
  ...
  /* 5B) UPSERT de filas con premio (>0) para este turno/fecha */
  ...
  /* 6) Totales del día (suma de todos los turnos) solo para candidates */
