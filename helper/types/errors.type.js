...
(function (ERROR_TYPE) {
    ...
    ERROR_TYPE[ERROR_TYPE["USER_NOT_FOUND"] = 1] = "USER_NOT_FOUND";
    ERROR_TYPE[ERROR_TYPE["BAD_REQUEST"] = 2] = "BAD_REQUEST";
    ERROR_TYPE[ERROR_TYPE["INVALID_CREDENTIALS"] = 3] = "INVALID_CREDENTIALS";
    ERROR_TYPE[ERROR_TYPE["INTERNAL_SERVER_ERROR"] = 4] = "INTERNAL_SERVER_ERROR";
    ERROR_TYPE[ERROR_TYPE["AUTH_ERROR"] = 5] = "AUTH_ERROR";
    ERROR_TYPE[ERROR_TYPE["USERNAME_IS_REQUIRED"] = 6] = "USERNAME_IS_REQUIRED";
    ERROR_TYPE[ERROR_TYPE["PASSWORD_IS_REQUIRED"] = 7] = "PASSWORD_IS_REQUIRED";
    ERROR_TYPE[ERROR_TYPE["NAME_IS_REQUIRED"] = 8] = "NAME_IS_REQUIRED";
    ERROR_TYPE[ERROR_TYPE["CASHIER_NUMBER_IS_REQUIRED"] = 9] = "CASHIER_NUMBER_IS_REQUIRED";
    ERROR_TYPE[ERROR_TYPE["FORBIDDEN"] = 10] = "FORBIDDEN";
    ERROR_TYPE[ERROR_TYPE["TOKEN_ERROR"] = 11] = "TOKEN_ERROR";
    ERROR_TYPE[ERROR_TYPE["NEW_USER_REQUIRED"] = 12] = "NEW_USER_REQUIRED";
    ERROR_TYPE[ERROR_TYPE["ID_REQUIRED"] = 13] = "ID_REQUIRED";
    ERROR_TYPE[ERROR_TYPE["INVALID_ID"] = 14] = "INVALID_ID";
